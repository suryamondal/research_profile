...
\begin{minipage}{1.05\textwidth}
  ...
  \item Published:
    ...
    \item I~Adachi~et~al. \emph{Measurement of time-dependent $CP$ violation in $B^0 \to \phi K_S^0$ decays using the Moriond 2023 dataset}, \href{https://doi.org/10.1103/PhysRevD.108.072012}{Physical Review D 108.7 (2023) 072012}
    \item I~Adachi~et~al. \emph{Novel method for the identification of the production flavor of neutral charmed mesons}, \href{https://doi.org/10.1103/PhysRevD.107.112010}{Physical Review D 107.11 (2023) 112010}
    \item I~Adachi~et~al. \emph{First search for a $\tau^+ \tau^{\mathstrut -}$ resonance in $e^+ e^{\mathstrut -} \to \mu^+ \mu^{\mathstrut -} \tau^+ \tau^{\mathstrut -}$ events with the Belle II experiment}, \href{https://doi.org/10.1103/PhysRevLett.131.121802}{Physical Review Letters 131.12 (2023) 121802}
    \end{enumerate} 
  \end{enumerate} 
  \begin{enumerate}[b.]
